...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 290, 670, 410));

        jLabel3.setBackground(new java.awt.Color(150, 240, 240));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        //login button
        if(jTextField1.getText().equals("gym") && jPasswordField1.getText().equals("mehfooz12"))
        {
            setVisible(false);
