...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String registrationno = jTextField9.getText();
        String age = jTextField10.getText();
        String amount = jTextField11.getText();
        try{
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("update member set name=?,mobilenumber=?,email=?, fathername=?,weight=?,registrationno=?,age=?,amount=? where id=?");
            ps.setString(1, name);
